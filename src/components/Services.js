        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-fuchsia-700 uppercase font-bold">services</h2>
                        
                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-fuchsia-700'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-fuchsia-700">We are deeply committed to the growth and success of our clients.</h2>
                    </div>
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-fuchsia-700 mb-4'>
                            ...
                            <h3 className="text-3xl  text-fuchsia-700 
                            font-bold">We <span className='font-black'>Build</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                With over 30 years of expertise in crafting high-quality, custom metal signage, nameplates, and labels, we bring precision engineering and innovative design to every product. From aluminum and stainless steel nameplates to brass plates and copper yantras, we ensure premium solutions tailored to enhance your business’s branding and operational efficiency.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl  text-fuchsia-700 font-bold">We <span className='font-black'>Collaborate</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>As a trusted partner since 1992, we work closely with our clients across industries to deliver customized solutions that meet their unique needs. Whether you’re scaling your operations or seeking specialized metal products, our collaborative approach guarantees reliability, exceptional quality, and client satisfaction.</p>
                            </div>
                        </div>
                    </div>
                </div>
